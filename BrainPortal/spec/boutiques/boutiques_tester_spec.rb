...
#   (3) Tests the generated portal task class
  ...
  describe 'local boutiques task' do
    ...
    context "Boutiques GeneratedTask Object" do
      ...
      it "should have no validation errors" do
        expect( @boutiquesTask.validation_errors ).to be_truthy
      end
    end
    ...
    context "Boutiques Generated Class Properties" do
      ...
      it "has pretty param names" do # Just test one of them is correct
    ...
    context "Generated Portal Task" do            
      ...
      describe "Generated after_form Method" do
        ...
        allGood = BasicTests.all? do |t|
          ...
          # The latter is excluded at a different level than after_form (since no input form will be created for it).
