...
# acts either as a MultilevelLocalDataProvider or a MultilevelSshDataProvider
...
# and more efficient MultilevelLocalDataProvider will be used.
class MultilevelSmartDataProvider < DataProvider
  ...
  def after_initialize_select_provider #:nodoc:
    self.select_local_or_network_provider(MultilevelLocalDataProvider,MultilevelSshDataProvider)
  end
