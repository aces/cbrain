...
class Bourreau < RemoteResource
  ...
  def start
    ...
    start_command = "cd #{self.ssh_control_rails_dir.to_s.bash_escape}; bundle exec ruby script/cbrain_remote_ctl #{proxy_args} start -e #{myrailsenv.to_s.bash_escape} -p #{port.to_s.bash_escape} 2>&1"
  ...
  def stop
    ...
    stop_command = "cd #{self.ssh_control_rails_dir.to_s.bash_escape}; bundle exec ruby script/cbrain_remote_ctl #{proxy_args} stop"
  ...
  def start_remote_console
    ...
    start_command = "cd #{self.ssh_control_rails_dir.to_s.bash_escape}; bundle exec ruby script/cbrain_remote_ctl #{proxy_args} console -e #{myrailsenv.to_s.bash_escape}"
