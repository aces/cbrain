...
class PortalController < ApplicationController
  ...
  def welcome #:nodoc:
    ...
    @groups                 = current_user.groups.sort { |a,b| a.name.casecmp(b.name) }
    ...
    bourreau_ids = Bourreau.find_all_accessible_by_user(current_user, :conditions => { :online => true } ).collect(&:id)
