...
def create #:nodoc:
  ...
  def operation #:nodoc:
    ...
    if do_in_spawn
      ...
      failure_count  = 0
      failed_list.each_value  { |v| failure_count += v.count }
      skipped_count  = 0
      skipped_list.each_value { |v| skipped_count += v.count }
