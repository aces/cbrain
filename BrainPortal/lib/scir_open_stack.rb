...
class ScirOpenStack < Scir
  ...
  class Session < Scir::Session #:nodoc:
    ...
    def run(job)
      ...
      vm = submit_VM("tglatard","PowchEdip0","http://204.19.23.16:5000/v2.0", "cbrain worker", "cbrain", "4f6920df-2670-437f-83b9-62682b5c8724", "http://204.19.23.16:8774/v2/9dd2bfba6bf040ad83e5140508aa31f0/flavors/0f1f9ac6-8156-4d27-8020-670833f264e8")
      return vm.id.to_s
    end
