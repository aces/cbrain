...
Rails.application.config.assets.precompile += %w( jquery.js jquery-ui.js jquery.form jquery_ujs chosen_1.8.7.jquery.min.js)
...
Rails.application.config.assets.precompile += %w( chosen_1.8.7.min.css )
