...
1. All your contributions must be written by a human.

We do *NOT* accept any code or comments generated by _AI_ (Artificial Intelligence) systems.
...
2. Keep your communications to simple sentences.
...
When providing a *Pull Request*, do not repeat the description of a problem if it's already described in an *Issue*.
